  ...
  return (
    <div
      ...
      className={clsx(
        ...
        dragOver ? "border-brand-deep bg-brand-pastel/40" : "border-line bg-surface hover:border-brand-deep/60"
      )}
    >
      <input
        ref={inputRef}
      ...
      <div className="flex flex-col items-center gap-3">
        <div className="h-12 w-12 rounded-full bg-brand-pastel flex items-center justify-center text-brand-deep">
