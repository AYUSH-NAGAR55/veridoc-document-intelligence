    ...
    <div>
      ...
      <section className="container-page pt-16 pb-8 grid md:grid-cols-2 gap-10 items-center">
        <div>
          <h1 className="text-4xl md:text-5xl font-semibold tracking-tight text-ink leading-[1.08]">
            Turn documents into <span className="text-blue-deep">verified</span> knowledge.
          </h1>
          ...
          <div className="mt-8 flex flex-wrap gap-3">
            <Link to="/documents?upload=1" className="bg-blue-deep text-white font-medium px-5 py-3 rounded-lg hover:bg-blue-deep/90 transition-colors">
              Upload a document
            </Link>
            <Link to="/documents" className="border border-line bg-surface px-5 py-3 rounded-lg font-medium text-ink hover:border-blue-deep/60 transition-colors">
      ...
      <section className="container-page py-20 border-t border-line text-center">
        ...
        <div className="mt-6 flex justify-center gap-3">
          <Link to="/documents?upload=1" className="bg-blue-deep text-white font-medium px-6 py-3 rounded-lg hover:bg-blue-deep/90 transition-colors">
            Upload a document
          </Link>
          <Link to="/dashboard" className="border border-line bg-surface px-6 py-3 rounded-lg font-medium text-ink hover:border-blue-deep/60 transition-colors">
            View dashboard
          </Link>
        </div>
      </section>
