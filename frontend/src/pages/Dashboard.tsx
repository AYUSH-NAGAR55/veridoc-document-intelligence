...
const TONE_CLASSES: Record<string, string> = {
  blue: "bg-blue-pastel text-blue-deep",
  ...
  return (
    <div className="p-6 md:p-8 max-w-6xl">
      <div className="flex items-center justify-between mb-6">
        ...
        <Link to="/documents?upload=1" className="bg-blue-deep text-white text-sm font-medium px-4 py-2.5 rounded-lg hover:bg-blue-deep/90 transition-colors">
          Upload a document
        </Link>
      </div>
      ...
      {loading ? (
        ...
        <div className="bg-surface border border-line rounded-xl2">
          <EmptyState
            ...
            action={
              <Link to="/documents?upload=1" className="bg-blue-deep text-white text-sm font-medium px-4 py-2.5 rounded-lg">
                Upload a document
              </Link>
            }
          />
