            ...
            <div key={item.id} className="bg-surface border border-line rounded-xl2 p-5">
              <div className="flex flex-wrap items-start justify-between gap-3">
                ...
                <div>
                  ...
                  <p className="font-medium text-ink max-w-xs line-clamp-2 break-words">{item.ai_value}</p>
                </div>
                <div>
              ...
              <div className="flex items-center gap-2 mt-4">
                ...
                <button onClick={() => setEditingId(editingId === item.id ? null : item.id)} className="flex items-center gap-1.5 text-sm bg-brand-pastel text-brand-deep px-3.5 py-2 rounded-lg font-medium">
              ...
              {editingId === item.id && (
                <div className="flex gap-2 mt-3">
                  <input
                    ...
                    className="flex-1 border border-line rounded-lg px-3 py-2 text-sm bg-canvas focus:border-brand-deep outline-none"
                  />
                  <button onClick={() => handle("correct", item.id)} className="bg-brand-deep text-white text-sm font-medium px-4 py-2 rounded-lg flex items-center gap-1.5">
