        ...
        {submitted ? (
          ...
          >
            <div>
              ...
              <input id="name" required className="mt-1 w-full border border-line rounded-lg px-3.5 py-2.5 bg-surface focus:border-brand-deep outline-none" />
            </div>
            <div>
              <label htmlFor="email" className="text-sm font-medium text-ink">Email</label>
              <input id="email" type="email" required className="mt-1 w-full border border-line rounded-lg px-3.5 py-2.5 bg-surface focus:border-brand-deep outline-none" />
            </div>
            <div>
              <label htmlFor="message" className="text-sm font-medium text-ink">Message</label>
              <textarea id="message" required rows={4} className="mt-1 w-full border border-line rounded-lg px-3.5 py-2.5 bg-surface focus:border-brand-deep outline-none" />
            </div>
            <button type="submit" className="bg-brand-deep text-white font-medium px-5 py-2.5 rounded-lg hover:bg-brand-deep/90 transition-colors">
              Send message
            </button>
          </form>
        )}
