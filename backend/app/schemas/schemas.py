...
CATEGORY_VALUES = (
    "document_metadata", "key_concept", "technology_protocol_tool",
    "algorithm_method", "entity", "numerical_value", "relationship",
    "table_data", "general",
)
...
class ExtractedField(BaseModel):
    ...
    # Additive, optional: what KIND of information this is (concept, protocol,
    # algorithm, entity, ...), so the UI can group general-document knowledge
    # instead of only ever showing invoice-style single fields. Existing
    # callers that don't send this still validate fine via the default.
    category: Literal[CATEGORY_VALUES] = "general"
